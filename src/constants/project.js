...
export const projectData = [
  {
    ...
    features: [{
      featTitle: 'Frontend features created with React and styled-components:',
      featInfo: 'user auth with JSON web tokens, requests to News API and custom API, hooks, functional components, and conditional rendering'
    },
    {
      featTitle: 'Backend is Express and MongoDB:',
      featInfo: 'celebrate/Joi, password hashing, centralized error handling, logging, request limiter, helmet and cors'
    }
    ],
  ...
  },
  {
    ...
    features: [{
      featTitle: 'Frontend features created with React and CSS:',
      featInfo: ' JSON web tokens, hooks, functional components and conditional rendering'
    },
    {
      featTitle: 'Backend is Express.js, Node.js, and MongoDB:',
      featInfo: ' celebrate/Joi, password hashing, centralized error handling, logging, request limiter, helmet and cors'
    }
    ],
